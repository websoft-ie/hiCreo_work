...
/**
    ...
    public function mytest(Request $request)
    {
        ...
        Editor::mytest($request, $to_unique_id);
    }
    /**
     ...
     * @return ResponseFactory|\Illuminate\Http\Response
     */
    public function user_copy(MoveItemRequest $request)
    {
        // Demo preview
        if (is_demo(Auth::id())) {
            return Demo::response_204();
        ...
        // Move item
        $copied = Editor::copy($request, $to_unique_id);
    ...
    public function user_move(MoveItemRequest $request)
    {
        ...
        // Move item
        return Editor::move($request, $to_unique_id);
