<template>
    <li class="menu-option" :class="[icon === 'trash' ? 'danger' : '']">
        <div class="icon">
            ...
            <copy-icon v-if="icon === 'copy' " size="17"></copy-icon>
            <plus-icon v-if="icon === 'add' " size="17"></plus-icon>
            <clipboard-icon v-if="icon === 'paste'" size="17"></clipboard-icon>
            <x-icon v-if="icon === 'cut'" size="17"></x-icon>
        </div>
