        ...
        methods: {
            moveItem() {
                ...
                if(!this.noSelectedItem){
                    this.$store.dispatch('moveItem', {to_id:this.selectedFolder.unique_id ,noSelectedItem: null})
                }

                if(this.noSelectedItem){
                    this.$store.dispatch('moveItem', {to_id:this.selectedFolder.unique_id ,noSelectedItem:this.pickedItem})
                }
